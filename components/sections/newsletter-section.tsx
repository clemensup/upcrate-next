    ...
    <section className="text-center text-purple-dark pt-6 pb-6 md:px-10 md:px-32 md:pt-20 md:pb-24">
      ...
      <div className="mx-5 mb-10 md:mb-0 md:max-w-6xl mx-auto px-10">
        ...
        <div className="md:flex gap-10 md:gap-20 justify-center">
          <div>
            <Image src="/newsletter/advantage01.png" width={332} height={332} />
            <p className="text-2xl font-bold text-center">
              Be the first to know about special offers
            </p>
          </div>
          <div>
            <Image src="/newsletter/advantage02.png" width={332} height={332} />
            <p className="text-2xl font-bold text-center">
              Receive exclusive discount codes for our shop
            </p>
          </div>
          <div>
            <Image src="/newsletter/advantage03.png" width={332} height={332} />
            <p className="text-2xl font-bold text-center">
