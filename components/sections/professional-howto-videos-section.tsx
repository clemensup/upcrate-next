    ...
    <section className="min-h-sectionBig md:min-h-sectionBigMd p-10 md:p-20 ">
      ...
      <div className="grid md:grid-cols-3 gap-10 md:gap-20 relative mt-10 md:mt-20">
        ...
        <div className="text-2xl text-purple-dark text-center flex h-full justify-between flex-col order-1 md:order-2">
          <div>
            <Image src="/how-to-videos/youtube.png" width={630} height={419} />
            <p className="mt-5 md:mt-10">
              To help you get started, each of our monthly featured artists
              films a video about their crates, preferred materials and drawing
              processes! Learn from the best and make the most out of the new
              supplies you own. Stay tuned over at our YouTube channel for more!
            </p>
          </div>
