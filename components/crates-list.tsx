    ...
    <section className="min-h-sectionBig md:min-h-sectionBigMd p-10 md:p-20 pt-20 -mt-20 md:-mt-10 relative overflow-hidden">
      ...
      <div className="z-10 relative text-purple-dark">
        ...
        <p className="mt-8 text-xl max-w-2xl mx-auto text-center">
          Looking for a specific box from your favorite artist or new materials
          to experiment with? Find all of our previous boxes below - you can
          even reorder them from our stock in case they aren’t sold out yet!
        </p>
