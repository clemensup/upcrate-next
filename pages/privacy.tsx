        ...
        <div className="max-w-6xl mx-auto">
          ...
          {lang === "en" ? (
            <div>
              ...
              <br />
              <br />
              Name of the cardholder, E-mail address, Customer number, Order
              number, Bank details, Credit card data, Credit card validity
              period, Credit card verification number (CVC), Date and time of
              transaction, Transaction amount, Name of the provider, Place
              <br />
              <br />
              When processing payments via Stripe, personal data is transmitted
              to Stripe. We cannot process a payment via Stripe without the
              submission of your personal data. You have the option to choose
              another payment method. For more information on opting out and
              opting out of Stripe, please visit:{" "}
            ...
            <div>
              ...
              <br />
              <br />
              Name des Karteninhabers, E-Mail-Adresse, Kundennummer,
              Bestellnummer, Bankverbindung, Kreditkartendaten, Gültigkeitsdauer
              der Kreditkarte, Prüfnummer der Kreditkarte (CVC), Datum und
              Uhrzeit der Transaktion, Transaktionssumme Name des Anbieters, Ort
              <br />
              <br />
              Bei der Zahlungsabwicklung über Stripe werden personenbezogene
              Daten an Stripe übermittelt. Ohne die Übermittlung Ihrer
              ...
              Zahlungsmethode zu wählen. Weitere Informationen zu Widerspruchs-
              und Beseitigungsmöglichkeiten gegenüber Stripe finden Sie unter:{" "}
              <a
                className="underline"
