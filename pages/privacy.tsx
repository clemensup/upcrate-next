...
export default function Privacy() {
  ...
  return (
    <Layout>
      <section className="p-10 md:p-20 text-purple-dark max-w-6xl mx-auto pb-20 md:pb-48">
        ...
        which personal information we collect, how we use it and what rights you
        have when using our website. Clemens Roosen (“Upcrate”, “we” or “us”) is
        responsible for the processing of personal data collected through the
        websites www.upcrate.art and www.upcrate.de.
        ...
        data. As far as on our sides personal data (for example name, address or
        E-Mail addresses) are raised, this takes place, as far as possible,
        ...
        transmits to us. These are: • Browser type and browser verse • used
        operating system • Referrer URL • Host name of the accessing computer •
        Time of the server request • Transmitting amount of data • IP address
        These data cannot be assigned to specific persons. There is no merge of
        this data with other data sources. We reserve the right to check this
        data retrospectively, if we become aware of specific indications for
        illegal use. The processing of this data is based on Art. 6 para. 1 lit.
        following DSGVO to ensure trouble-free operation of our website.
        ...
        fulfill your order). Processing is based on Art. 6 para. 1 lit. b DSGVO
        and is required to fulfill a contract with you. A disclosure of your
        data is done, for example, to shipping companies and payment service
        providers.
        ...
        address, message text) will only be collected in the amount provided by
        you. The data serve the purpose of contacting. By sending your message,
        you consent to the processing of the transmitted data. The processing is
        based on Art. 6 para 1 lit. a GDPR. You can revoke your consent at any
        time. We only use your e-mail address to process your request. Your data
        ...
        sending the newsletter at any time, e.g. through the “unsubscribe” link
        in the newsletter. The data processed before we receive your request may
        ...
        <br />
        <br />
        MailChimp is a service which organizes and analyzes the distribution of
        newsletters. If you provide data (e.g. your email address) to subscribe
        to our newsletter, it will be stored on MailChimp servers in the USA.
        ...
        consent. You may revoke your consent at any time by notifying us or the
        carrier.
        ...
        All PayPal transactions are subject to the PayPal Privacy Policy. These
        can be found at https://www.paypal.com/en/webapps/mpp/ua/privacy-full
        ...
        tailored online experience when using the checkout. Processing is based
        on Art. 6 para. 1 lit. a DSGVO with your consent. You can revoke your
        consent at any time without affecting the legality of the processing
        carried out on the basis of the consent to revocation. You can prevent
        the storage of cookies by selecting appropriate technical settings of
        ...
        <br />
        <br />A detailed list of cookies and an explanation of their purpose can
        be found here
        ...
        If you have opted for Klarna’s payment services Klarna Rechnung and / or
        Klarna installment purchase as a payment option, you have consented to
        the following personal data such as name and surname, address, date of
        birth, necessary for the processing of the invoice purchase and an
        identity and credit check, Gender, e-mail address, IP address, telephone
        number as well as the data necessary for the settlement of the invoice
        purchase, which are related to the order, such as the number of
        articles, article number, invoice amount and taxes in percent, levied
        and to Klarna have transmitted. The data processing serves the purpose
        of the offer of the payment methods invoice purchase and installment
        purchase as well as the necessary credit check. Processing is based on
        Art. 6 para. 1 lit. a DSGVO with your consent. You may revoke your
        consent at any time by notifying us without affecting the legality of
        the processing based on the consent to revocation.
        <br />
        <br />
        The transmission of this data takes place so that Klarna can prepare an
        invoice for the processing of your purchase with the invoice processing
        you require and carry out an identity and credit check. Klarna needs the
        personal data of the buyer in order to obtain information from credit
        reference agencies for the purposes of identity and credit checks. In
        Germany, these may be the following credit bureaus:
        <br />
        <br />
        ...
        future. Klarna calculates these score values ​​based on a scientifically
        recognized mathematical-statistical procedure. Klarna will also use your
        address data. If this calculation shows that your creditworthiness is
        not met, Klarna will inform you immediately.
        <h3 className="text-xl font-bold mt-10 md:mt-8">
        ...
        process, use and transmit the personal data insofar as this is necessary
        for contractual payment processing by Klarnas Services, is required by
        law, or is required by a court or an authority.
        <br />
        <br />
        ...
        <h2 className="text-2xl font-bold mt-10 md:mt-8">1. Browser plugin</h2>
        ...
        address) and the processing of this data by Google by downloading the
        ...
        <br />
        <br />
        In accordance with Art. 17 GDPR, they have the right to demand that the
        relevant data be deleted without delay, or, alternatively, to require a
        ...
        <h2 className="text-2xl font-bold mt-10 md:mt-8">Comments and posts</h2>
        If users leave comments or other posts, their IP addresses may be based
        on our legitimate interests as defined in Art. 6Abs. 1 lit. f. DSGVO be
        stored for 7 days. This is for our own safety, if someone leaves illegal
        content in comments and contributions (insults, prohibited political
        propaganda, etc.). In this case, we may be sued for the comment or post
        ...
        purposes, including the receipt of advertising. After the objection, we
        will stop the processing of the relevant data for the purpose of direct
        mailing.
        ...
        <br />
        <br />
        If SSL encryption is enabled, the data you submit to us can not be read
        by third parties.
        ...
        browser cache. This is necessary so that your browser can also display a
        visually improved presentation of our texts. If your browser does not
        support this feature, a default font will be used by your computer for
        viewing.
        <br />
        <br />
        ...
        enforce the rights of the affected party. US networks and platforms that
        are certified under the Privacy Shield commit to comply with EU privacy
        policies.
        <br />
        <br />
        ...
        Dublin 4, Ireland) – Privacy Policy:
        ...
        <br />
        <br />
        Tumblr (Tumblr, Inc., 35 East 21st St., 10th Floor, New York, NY 10010,
        USA)
        <br />
        <br />
        ...
        2, Ireland („Facebook“). The plugins can display interaction elements or
        content (e.g. videos, graphics or text contributions) and can be
        recognized by one of the Facebook logos (white “f” on a blue tile, the
        terms “like”, “like” or a “thumbs up” sign ) or are marked with the
        addition „Facebook Social Plugin“. The list and the appearance of the
        Facebook social plugins can be viewed here:
        https://developers.facebook.com/docs/plugins/.
        <br />
        <br />
        Facebook is certified under the Privacy Shield Agreement and thus offers
        a guarantee to comply with European data protection law
        (https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&status=Active).
        <br />
        <br />
        When a user calls up a function of this online offer that contains such
        a plugin, his device establishes a direct connection with the Facebook
        servers. The content of the plug-in is transmitted directly from
        Facebook to the user’s device, which integrates it into the online
        offer. In doing so, user profiles can be created from the processed
        data. We therefore have no influence on the amount of data that Facebook
        collects with the help of this plugin and therefore informs users
        ...
        <br />
        <br />
        The purpose and scope of the data collection and the further processing
        and use of the data by Facebook as well as the related rights and
        setting options to protect the privacy of users can be found in
        Facebook’s data protection information:
        https://www.facebook.com/about/privacy/.
        <br />
        <br />
        If a user is a Facebook member and does not want Facebook to collect
        data about him through this online offer and link it to his member data
        stored on Facebook, he must log out of Facebook before using our online
        offer and delete his cookies. Further settings and contradictions to the
        use of data for advertising purposes are possible within the Facebook
        profile settings: https://www.facebook.com/settings?tab=ads or via the
        US website http://www.aboutads.info / choices / or the EU page
        ...
        Functions and contents of the Twitter service, offered by Twitter Inc.,
        1355 Market Street, Suite 900, San Francisco, CA 94103, USA, can be
        integrated into our online offer. This can include, for example, content
        such as images, videos or texts and buttons with which users can express
        their favor with regard to the content, subscribe to the authors of the
        content or our contributions. If the users are members of the Twitter
        platform, Twitter can assign the above-mentioned content and functions
        to the profiles of the users there. Twitter is certified under the
        Privacy Shield Agreement and thus offers a guarantee to comply with
        ...
        website. Pinterest is a so-called social network. A social network is an
        Internet-based social meeting place, an online community that usually
        allows users to communicate with each other and interact in virtual
        space. A social network can serve as a platform for sharing views and
        experiences, or allows the Internet community to provide personal or
        business information. Among other things, Pinterest enables users of the
        social network to publish picture collections and individual pictures as
        well as descriptions on virtual pinboards (so-called pinnings), which in
        turn can be shared by other users (so-called repinnen) or commented on.
        <br />
        <br />
        ...
        the person concerned is automatically pinterested Component causes a
        representation of the corresponding Pinterest component of Pinterest to
        be downloaded. More information about Pinterest is available at
        https://pinterest.com/. As part of this technical process, Pinterest is
        aware of which specific bottom of our website is visited by the person
        concerned.
        <br />
        <br />
        If the data subject is logged in to Pinterest at the same time,
        Pinterest recognizes with each visit of our website by the data subject
        and during the entire duration of the respective stay on our website,
        which specific underside of our website visited the data subject. This
        information is collected by the Pinterest component and assigned by
        Pinterest to the affected Pinterest account of the data subject. If the
        person concerned activates a Pinterest button integrated on our website,
        Pinterest assigns this information to the personal Pinterest user
        account of the person concerned and saves this personal data.
        <br />
        <br />
        Pinterest always receives information from the Pinterest component that
        ...
        information to Pinterest by the person concerned is not intended, it can
        prevent the transfer by logging out of your Pinterest account before
        calling our website.
        <br />
        <br />
        ...
        <br />
        <br />
        YouTube’s operating company is YouTube, LLC, 901 Cherry Ave., San Bruno,
        CA 94066, USA. YouTube, LLC is a subsidiary of Google Inc., 1600
        ...
        technology system to be represented by the respective YouTube component
        to download an illustration of the corresponding YouTube component from
        YouTube. More information about YouTube can be found at
        https://www.youtube.com/yt/about/en/. As part of this technical process,
        YouTube and Google will be aware of which specific bottom of our site
        ...
        information will be collected by YouTube and Google and associated with
        the affected person’s YouTube account.
        <br />
        <br />
        ...
        on to YouTube and Google by the person concerned, the latter may prevent
        the transmission from logging out of their YouTube account before
        calling our website.
        <br />
        <br />
        ...
        allow you to share a post or page with Tumblr or to follow the provider
        on Tumblr. When you visit one of our websites using the Tumblr button,
        the browser establishes a direct connection to the Tumblr servers. We
        have no control over the amount of data that Tumblr collects and
        transmits using this plug-in. According to the current state, the IP
        address of the user as well as the URL of the respective website are
        transmitted.
        <br />
        <br />
